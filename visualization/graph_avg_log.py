...
def growth_graph(graphtype, file_data):
    ...
    name_proper = {'Breed': 'Breed', 'Diffus': 'Dispersion', 'Rd_grav': 'Road', 'Slp_res': 'Slope', 'Spread': 'Spread'}
    name = name_proper.get(name)
...
if __name__=="__main__":
    ...
    for graph_type in {"spread", "breed", "slp_res", "rd_grav", "diffus"}:
